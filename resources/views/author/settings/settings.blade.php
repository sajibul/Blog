                       ...
                       <div class="body">
                           ...
                           <div class="tab-content">
                               <div role="tabpanel" class="tab-pane fade in active" id="profile">
                                   <b>Profile</b>
                            <form action="{{route('author.setting.profile')}}" method="post" enctype="multipart/form-data">
                              @csrf
                              @method('PUT')
                             ...
                             <div class="row clearfix">
                               ...
                               <div role="tabpanel" class="tab-pane fade" id="password">
                                   <b>Password</b>
                                <form action="{{route('author.setting.password')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    @csrf
                                    @method('PUT')
                                <div class="row clearfix">
                                   <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
