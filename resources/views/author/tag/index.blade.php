                                   ...
                                   <tbody>
                                     @foreach($taginfo as $tag)
                                       <tr>
                                           ...
                                           <td>{{$tag->tag_name}}</td>
                                           <td>
                                             <a href="{{route('tag.edit',$tag->tag_id)}}"><i class="fa fa-pencil-square fa-lg"></i></a>
                                             <button type="button" name="button" onclick="Tag({{$tag->tag_id}})"><i class="fa fa-trash fa-lg"></i></button>
                                             <form id="tag-{{$tag->tag_id}}" action="{{route('tag.destroy',$tag->tag_id)}}" method="post">
                                               @csrf
                                               @method('Delete')
                                             </form>
                                           </td>
