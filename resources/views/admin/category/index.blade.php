                                   ...
                                   <tbody>
                                     @foreach($infoCategries as $categries)
                                       <tr>
                                           ...
                                           <td>
                                             <a href="{{url('admin/categorie/'.$categries->id)}}"><i class="fa fa-plus-square fa-lg"></i></a>
                                             <a href="{{url('admin/categorie/'.$categries->id.'/edit')}}"><i class="fa fa-pencil-square fa-lg"></i></a>
                                             <button type="button" name="button" onclick="Category({{$categries->id}})"><i class="fa fa-trash fa-lg"></i></button>
                                             <form id="category-{{$categries->id}}" action="{{route('categorie.destroy',$categries->id)}}" method="post">
                                               @csrf
                                               @method('Delete')
                                             </form>
                                           </td>
