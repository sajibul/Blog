                         ...
                         <div class="panel-heading">
                            <div class="col-md-9 heading_title">
                             ...
                             <div class="col-md-3 text-right">
                             	<a href="{{url('admin/post/create')}}" class="btn btn-sm btn btn-primary"><i class="fa fa-plus-circle"></i> Add Information</a>
                            </div>
                                       ...
                                       <tr>
                                           ...
                                           <td>
                                             @if($allpost->is_approve==1)
                                                <a href="{{url('post/pending/'.$allpost->id)}}" class="btn btn-success">Approve</a>
                                              @else
                                              <a href="{{url('post/approved/'.$allpost->id)}}" class="btn btn-danger">Pending</a>
                                              @endif
                                            </td>
                                           <td>
